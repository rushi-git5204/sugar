...
public partial class Sugar_Report_pgeSaleBill_Print : System.Web.UI.Page
{
    ...
    protected void btnWhatsApp_Click(object sender, EventArgs e)
    {
        ...
        if (table.Rows.Count > 0)
        {
            ...
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "api-call", "javascript:sendPdfToWatsapp('" + bill_no + "','" + base64String + "', '" + uploadedFileName + "','" + instanceid + "','" + accesstoken + "',' DO NO: " + no + " TRUCK NO: " + Truck_NO + " SALE BILL NO: " + sbno + "','" + Moblie_Number + "', 'LATASOFTWARE','" + mobileNumber + "');", true);
