...
public partial class Sugar_BussinessRelated_pgeSaudaBookUtility : System.Web.UI.Page
{
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        ...
        string massage = "Mill_Name:" + lblmillname.Text.Trim() + ",Grade:" + lblgrade.Text.Trim() + ",Mill_Rate:" + lblmillrate.Text.Trim() +
        ...
        string message = " HI " + Environment.NewLine + " SALE ORDER CONFIRMATION FROM NAVKAR TRADERS PUNE" + Environment.NewLine +
                 " *_SALE ID NO:  " + tenderdetailidnew + "_* " + Environment.NewLine + " MILL NAME: " + lblmillname.Text + "" + Environment.NewLine +
                 " QUNTIL: " + quntal + "  " + Environment.NewLine + " GRADE: " + GRADE + "  " + Environment.NewLine +
                 " SALE RATE: " + sale_rate + "  " + Environment.NewLine + " COMMSSION: " + commision_rate + "  " + Environment.NewLine + " SALE DATE: " + txtDetailSaudaDate.Text + " " + Environment.NewLine +
                 " PAYMENT DATE: " + txtDetailLiftingDate.Text + " " + Environment.NewLine + "  " + Environment.NewLine + " " + Environment.NewLine +
                 " FOR DELIVERY JUST SEND THIS MSG ON 9225112789 " + Environment.NewLine + " *_SALE ID:  " + tenderdetailidnew + "_* " + Environment.NewLine +
                 " TRUCK NO: " + Environment.NewLine + " QTY:" + Environment.NewLine + " RATE: " + Environment.NewLine +
                 " BILL TO NAME: " + Environment.NewLine + " CITY: " + Environment.NewLine + " GST: " + Environment.NewLine +
                 " SHIPP TO NAME: " + Environment.NewLine + " CITY: " + Environment.NewLine + " GST: " + Environment.NewLine +
